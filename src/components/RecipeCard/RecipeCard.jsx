...
function RecipeCard() {
    return (
        <div>
            <img src="https://curitibadegraca.com.br/bolo-de-chocolate-e-cobertura-de-brigadeiro/"/>
            <Badge/>
            <FavoriteButton/>
